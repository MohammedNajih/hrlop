...
if($_POST) {
    ...
    if($clawzpass==$sifre){
        header("Location:U2NyaXB0IHdjbGF3eiB0YXJhZsSxbmRhbiBrb2RsYW5txLHFn3TEsXIgw6dhbG1hecSxbi4gxLBsZXRpxZ9pbSBpbnN0YWdyYW0gd2NsYXd6ISEhIA.php");
    }
    else {
...
<body> 
    <center>
        <div id="div" class="div">
         ...
         <p>Şifreyi bilmiyorsanız <a href="https://instagram.com">shuterlook</a> tıklayarak instagram hesabıma ulaşabilirsiniz.</p> <br><br>
    </div>
    </center>
    <script>
